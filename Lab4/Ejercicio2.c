...
int dinero_que_debe_pagar ()
{
	...
	printf(" La cantidad de huevos que come cada amigo: %.1f", huevos_a_comer_por_persona);
    ...
    printf("\n Antonio le debe pagar a juan: %.1f", total_a_pagar_a_juan);
    printf("\n Antonio le debe pagar a manuel: %.1f", total_a_pagar_a_manuel);
